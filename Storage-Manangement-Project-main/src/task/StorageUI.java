...
public class StorageUI {
    ...
    static void pListUI() {
        ...
        for(int i=0; i<storage.pList.size(); i++) {
            System.out.println(storage.pList.get(i).id + "\t" +
                    ...
                    storage.pList.get(i).quantity + "\t" + //get(read)product class other instance members
                    storage.pList.get(i).unit + "\t" + //get(read) product class other instance members
                    storage.pList.get(i).shelf //get(read) product class other instance members
                    );
        }
        System.out.println("==============================================================================");
        returnMenu();
    ...
    static void pShelvingUI() {
        ...
        storage.pShelving(pID, pShelf);//comes from storage class and first places is planning interface
